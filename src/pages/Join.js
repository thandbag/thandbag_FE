        ...
        <Grid margin="70px 0 0 0" flex="flex; align-items:center; flex-direction: column">
            ...
            <FormGroup>
                ...
                <Grid margin="20px 0px 0px 0px">
                    <Input boxSizing="border-box" size="17px" bg="#FBF7F7" color="#FF5454" radius="10px" padding="10px" value={nickname} _onChange={onChangeNick} height="47px" width="300px" placeholder="닉네임"></Input>
